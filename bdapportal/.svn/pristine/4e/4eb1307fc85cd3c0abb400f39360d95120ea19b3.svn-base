        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <div class="content" style="margin-top:60px;">
                    <div class="container">
                    <form class="form-horizontal" role="form" id="referenceUpdateForm" name="referenceUpdateForm" method="post" action="<%=contextPath%>/reference/update.do" accept-charset="utf-8">
						<h4 class="m-t-0 header-title" style="padding:10px;"><b>게시물 수정</b></h4>
