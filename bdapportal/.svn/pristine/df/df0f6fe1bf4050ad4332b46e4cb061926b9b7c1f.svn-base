...
<body class="fixed-left widescreen">
           ...
           <%--  <div class="left side-menu">
            ...
            <div class="content-page">
                ...
                <div class="content" style="margin-top:60px;">
                    <div class="container">
                    	<form class="form-horizontal" role="form" id="referenceSearchForm" method="post" action="<%=contextPath%>/reference/list.do" accept-charset="utf-8">
                        				...
                        				<div class="col-md-1">
	                                            ...
	                                            <div class="form-group" style="margin-bottom:10px;">
	                                            	<div class="col-md-12 text-left">
                                     					<button class="btn btn-primary waves-effect waves-light" type="button" onclick="javascript:referenceSearch();">검색</button>
	                                                </div>
	                                            </div>
                       ...
                       <div class="col-lg-12" style="margin-bottom:10px;">
								<div class="card-box">
                                    <div class="table-responsive">
	                       				...
	                       				<table id="referenceList" style="width:100%;"></table>
        ...
        <script type="text/javascript">
    		...
    		$(function(){
     			$("#referenceList").jqGrid({  
     				//ajax 호출할 페이지
     				url:'<%=contextPath%>/getReferenceList.do?'+param,
    			   ...
    			   loadComplete : function(data){
					...
					onCellSelect : function(rowid,index,contents,event){
			   			...
			   			if(cm[index].name == 'title'){
				   			...
				   			document.location.href = "<%=contextPath%>/reference/view.do?bbsPostId="+id;	
			   			}
			   		}
     			});
     		});         
			...
			function goMod(){
					var checkArr = $("#referenceList").getGridParam('selarrrow');
					...
					if(checkArr.length > 1){		//두개 이상 선택 되면 alert 띄우기
						...
						if(confirm("수정 하시겠습니까?")){
							var bbsPostId = "";
							var bbsParentId = "";
							bbsParentId = $("#referenceList").jqGrid('getRowData',checkArr).parentId;
							bbsPostId = $("#referenceList").jqGrid('getRowData',checkArr).postId;
							
							if(bbsParentId == ""){			//게시글과 답글의 수정 페이지를 구분한다.
								document.location.href = "<%=contextPath%>/reference/mod.do?bbsPostId="+bbsPostId;
							}else{
								document.location.href = "<%=contextPath%>/reply/mod.do?bbsParentId="+bbsParentId+"&bbsPostId="+bbsPostId+"&bbsType=BO3";
							}
					...
					if(checkArr.length == 0){
						...
						if(confirm(checkArr.length+"개의 게시물이 삭제 됩니다. 정말 진행 하시겠습니까?")){
							...
							for(var i = 0; i < checkArr.length; i++){
								bbsPostId += $("#referenceList").jqGrid('getRowData',checkArr[i]).postId+"^";
							}
