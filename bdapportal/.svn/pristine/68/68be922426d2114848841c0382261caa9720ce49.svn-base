...
public class ReferenceController {
	...
	@RequestMapping("/reference/list.do")				
	public ModelAndView referenceList(HttpServletRequest request, HttpServletResponse response){
		
		ModelAndView mav = new ModelAndView("/list/referenceList");
	...
	public void getreferenceList(HttpServletRequest request, HttpServletResponse response, @PageableDefault(sort = { "BBS_REG_DT" }, direction = Direction.DESC, size = 15) Pageable pageable) {
		...
		try{
			...
			List<BdapBbs> bbsList =	bbsService.getReferenceList(searchVO,startnum,rows);	
			long referenceListCount = bbsService.getReferenceListCount(BbsConstant.REFERENCE_CODE,searchVO);
			...
			int forLastPage = (referenceListCount % rows > 0)? 1:0;
			jsonObj.put("records", referenceListCount);
			jsonObj.put("total", (referenceListCount/rows)+forLastPage) ;
	...
	@RequestMapping("/reference/insert.do")							
	public String referenceInsert(HttpServletRequest request, HttpServletResponse response) throws IllegalStateException, IOException {
		...
		try {
			...
			bdapBbs.setBbsType(BbsConstant.REFERENCE_CODE);
		...
		return "redirect:/reference/list.do";
		//return mav;
	}
	
	
	@RequestMapping("/reference/view.do")							
	public ModelAndView referenceView(HttpServletRequest request, HttpServletResponse response) {
				
		ModelAndView mav = new ModelAndView("/view/referenceView");
		...
		try{
			...
			bbs.setBbsHit(++hit);
			bbsService.referenceInsert(bbs);
			...
			mav.addObject("referenceView", bbs);
	...
	@RequestMapping("/reference/reg.do")							
	public ModelAndView referenceReg(HttpServletRequest request, HttpServletResponse response) {
				
		ModelAndView mav = new ModelAndView("/reg/referenceReg");
	...
	@RequestMapping("/reference/mod.do")							
	public ModelAndView referenceMod(HttpServletRequest request, HttpServletResponse response) {
				
		ModelAndView mav = new ModelAndView("/mod/referenceMod");
	...
	@RequestMapping("/reference/del.do")							
	public String referenceDel(HttpServletRequest request, HttpServletResponse response) {
	...
	@RequestMapping("/reference/update.do")							
	public String referenceUpdate(HttpServletRequest request, HttpServletResponse response) {
