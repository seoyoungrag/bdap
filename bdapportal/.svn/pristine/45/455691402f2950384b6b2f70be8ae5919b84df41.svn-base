                ...
                <div class="content" style="margin-top:60px;">
                    <div class="container">
						...
						<div class="row" style="margin-left:0px; padding:0px;">
							...
							<div class="col-sm-6 col-lg-10 widget-simple-chart card-box" style="padding:20px; padding-bottom:0px; margin-bottom:10px; width:82.5%">
                                <div class="tabs-vertical-env nav-tab-left navtab-custom">
                                    <ul class="nav tabs-vertical">
                                        <li class="active">
                                            <a aria-expanded="true" href="#v-home" data-toggle="tab">공지사항</a>
                                        </li>
                                        <li>
                                            <a aria-expanded="false" href="#v-profile" data-toggle="tab">Q & A</a>
                                        </li>
                                        <li>
                                            <a aria-expanded="false" href="#v-messages" data-toggle="tab">자료실</a>
                                        </li>
                                        <li>
                                            <a aria-expanded="true" href="#v-settings" data-toggle="tab">비정기자료</a>
                                        </li>
										<li>
                                            <a aria-expanded="true" href="#v-test" data-toggle="tab">개발요청</a>
                                        </li>
                                    </ul>

                                    <div class="tab-content"  style="padding-top:5px; padding:0px; height:220px; width:100%;">
	                    ...
	                    <div class="row" style="margin-left:10px; margin-bottom:0px; margin-right:0px;">
                            <div class="col-lg-12 card-box" style="margin-bottom:10px;" >
                        	<h4 class="text-dark  header-title m-t-0" style="margin-left:10px;">테이블별 일 적재 현황</h4>
                        	<div id="chartdiv"></div>
                            </div>
                        </div>  
        ...
        <script type="text/javascript">
            ...
            function generateChartData() {
                ...
                for (var i = 0; i < 30; i++) {
                    ...
                    var visits = Math.round(Math.random() * 100)+1;
                    var visits2 = Math.round(Math.random() * 100)+1;
