...
<body class="fixed-left widescreen">
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <div class="content" style="margin-top:60px;">
                    <div class="container">
                    <form class="form-horizontal" role="form" id="devreqSearchForm" method="post" action="<%=contextPath%>/devreq/list.do" accept-charset="utf-8">
                        				...
                        				<div class="col-md-1">
	                                            ...
	                                            <div class="form-group" style="margin-bottom:10px;">
	                                            	<div class="col-md-12 text-left">
                                     					<button class="btn btn-primary waves-effect waves-light" type="button" onclick="javascript:devreqSearch();">검색</button>
	                                                </div>
	                                            </div>
                       ...
                       <div class="col-lg-12" style="margin-bottom:10px;">
								<div class="card-box">
                                    <div class="table-responsive">
	                       				...
	                       				<table id="devreqList" style="width:100%;"></table>
        ...
        <script type="text/javascript">
    		...
    		$(function(){
     			$("#devreqList").jqGrid({  
     				//ajax 호출할 페이지
     				url:'<%=contextPath%>/getDevreqList.do?'+param,
					...
					onCellSelect : function(rowid,index,contents,event){
						...
						var cm = $(this).jqGrid('getGridParam','colModel');	
			   			if(cm[index].name == 'title'){
				   			...
				   			document.location.href = "<%=contextPath%>/devreq/view.do?bbsPostId="+id;
			   			}
			...
			function goReg(){			//개발요청
    			...
    			document.location.href = "<%=contextPath%>/devreq/reg.do";
    			
    		}
    		
			function goMod(){
    			
				var checkArr = $("#devreqList").getGridParam('selarrrow');
				...
				if(checkArr.length > 1){		//두개 이상 선택 되면 alert 띄우기
					...
					if(confirm("수정 하시겠습니까?")){
						var bbsPostId = "";
						var bbsParentId = "";
						bbsParentId = $("#devreqList").jqGrid('getRowData',checkArr).parentId;
						bbsPostId = $("#devreqList").jqGrid('getRowData',checkArr).postId;
						
						if(bbsParentId == ""){			//게시글과 답글의 수정 페이지를 구분한다.
							document.location.href = "<%=contextPath%>/devreq/mod.do?bbsPostId="+bbsPostId;
						}else{
							document.location.href = "<%=contextPath%>/reply/mod.do?bbsParentId="+bbsParentId+"&bbsPostId="+bbsPostId+"&bbsType=BO5";
						}
				...
				if(checkArr.length == 0){
					...
					if(confirm(checkArr.length+"개의 게시물이 삭제 됩니다. 정말 진행 하시겠습니까?")){
						...
						for(var i = 0; i < checkArr.length; i++){
							bbsPostId += $("#devreqList").jqGrid('getRowData',checkArr[i]).postId+"^";
						}
		    			document.location.href = "<%=contextPath%>/devreq/del.do?bbsPostIdArr="+bbsPostId;	
					}
				}
		...
		function devreqSearch(){
			
			$("#devreqSearchForm").submit();
		}
