...
<body class="fixed-left widescreen">
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <div class="content" style="margin-top:60px;">
                    <div class="container">
						<h4 class="m-t-0 header-title" style="padding:10px;"><b>복호화 권한 조회</b></h4>
                       	<div class="col-lg-12" style="margin-bottom:10px;" id="decTable">
								<div class="card-box">
                       				<div class="table-responsive">
	                       				<table id="decRoleList" style="width:100%;"></table>
       ...
       <script src="<%=contextPath%>/resources/kt/js/moment.js"></script>
        ...
        <script type="text/javascript">
    		...
    		$(function(){
     			$("#decRoleList").jqGrid({  
     				url:'<%=contextPath%>/getDecRoleList.do',
     				loadtext : '로딩중..',
     				//응답값
     				datatype: "json",
     				styleUI : 'Bootstrap',
