       ...
       <script src="<%=contextPath%>/resources/kt/js/moment.js"></script>
        ...
        <script type="text/javascript">
          ...
          var searchType = "<%=searchVO.getSearchType()%>";
            ...
            var colModelArr = [{name:'0',align: 'center'},{name:'1', index:'CheckResult',align: 'center'}];
            var groupHeadersArr = [];
            ...
            for(var i = 2; i < colNamesArr.length; i++){
            	colModelArr.push({name: i ,align: 'center'});
     			...
     			$("#loadStatusList").jqGrid(
     					...
     					{caption:"Excel DownLoad",
     		     			onClickButton: function() {
     		     				...
     		     				//var pdata = $("#loadStatusList").jqGrid('getGridParam', 'data');
