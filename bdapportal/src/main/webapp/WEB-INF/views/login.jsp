...
%>
<!DOCTYPE html>
<html style="background-color:#494e50;">
    <head>
        <meta charset="utf-8">
        ...
        <style>
			.footer { width:100%; background:#494e50; color:#fff;}
        </style>
    </head>
    <body>
        <div class="wrapper-page">
            <div class="text-center">
                <a href="index.html" class="logo logo-lg" ><span style="font-size:50px;">Big Data Analytics Platform</span> </a>
            </div>
			<div class="text-center" style="width:60%;margin-left:20%;margin-top:5%;">
				<form class="form-horizontal m-t-20" onsubmit="doLogin(); return false;">
	                ...
	                <div class="form-group">
	                    <div class="col-xs-12" style="margin:10% 0% 0% 0%; ">
	                        ...
	                        <div class="col-xs-12" style="margin:0px; padding:0px;width:114px;float:right;">
		...
		<script src="<%=contextPath%>/resources/kt/js/jquery.cookie.js"></script>
        ...
        <script type="text/javascript">
			...
			function rememberMe(){
				$.cookie('bdapPortalLoginId',$('#loginId').val());
			}
	
	       	function getUserIdFromCookie(){
	       	    if(!!$.cookie('bdapPortalLoginId')){
	       	    	$('#loginId').val($.cookie('bdapPortalLoginId'));
