        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <div class="content" style="margin-top:60px;">
                    <div class="container">
                    <form class="form-horizontal" role="form" id="devreqUpdateForm" name="devreqUpdateForm" method="post" action="<%=contextPath%>/devreq/update.do" accept-charset="utf-8">
						<h4 class="m-t-0 header-title" style="padding:10px;"><b>개발요청 진행 현황 수정</b></h4>
