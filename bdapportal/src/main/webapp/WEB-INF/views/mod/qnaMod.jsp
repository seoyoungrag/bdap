	                                                ...
	                                                <label class="col-md-3 control-label" style="text-align:right;">질문분류 :  </label>
		                                                <div class="col-md-3">
			                                                <select class="selectpicker" name="category">
															  <option value="시스템" <%=bbs.getBbsCategory().equals("시스템")?"selected":"" %>>시스템</option>
															  <option value="데이터" <%=bbs.getBbsCategory().equals("데이터")?"selected":"" %>>데이터</option>
															</select>
		                                                </div>
	                                                <label class="col-md-3 control-label" style="text-align:right;">질문세부분류 :  </label>
		                                                <div class="col-md-3">
			                                                <select class="selectpicker" name="categorySub">
															  <option value="포탈" <%=bbs.getBbsCategorySub().equals("포탈")?"selected":"" %>>포탈</option>
															  <option value="Rstudio" <%=bbs.getBbsCategorySub().equals("Rstudio")?"selected":"" %>>Rstudio</option>
															  <option value="SAS" <%=bbs.getBbsCategorySub().equals("SAS")?"selected":"" %>>SAS</option>
															  <option value="NDAP" <%=bbs.getBbsCategorySub().equals("NDAP")?"selected":"" %>>NDAP</option>
															  <option value="연동테이블" <%=bbs.getBbsCategorySub().equals("연동테이블")?"selected":"" %>>연동테이블</option>
															  <option value="자료요청" <%=bbs.getBbsCategorySub().equals("자료요청")?"selected":"" %>>자료요청</option>
															  <option value="마트" <%=bbs.getBbsCategorySub().equals("마트")?"selected":"" %>>마트</option>
															</select>
		                                                </div>
	                                            </div>
