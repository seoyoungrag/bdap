        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <div class="content" style="margin-top:60px;">
                    <div class="container">
						<h4 class="m-t-0 header-title" style="padding:10px;"><b>Q & A 조회</b></h4>
                       		...
                       		<div class="card-box" style="">
                       			<div class="row">
                        				<div class="col-md-6" style="padding-left:20px;">
                        					...
                        					<%if(bbs.getBbsParentBbsId() == null || bbs.getBbsParentBbsId().equals("")){ %>
	                                            <div class="form-group" style="margin-bottom:10px;">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input class="form-control" type="text"  placeholder="제목을 입력 하세요." value="<%=bbs.getBbsTitle()%>" readOnly="true">
	                                                </div>
	                                            </div>
	                                             <%}else{ %>
                        					...
                        					<form class="form-horizontal" role="form">
	                                            ...
	                                            <div class="form-group" style="margin-bottom:10px;">
	                                                ...
	                                                <label class="col-md-3 control-label" style="text-align:right;">질문분류 :  </label>
		                                                <div class="col-md-3">
		                                                <input class="form-control" type="text" placeholder="제목을 입력 하세요." value="<%=bbs.getBbsCategory()%>" readOnly="true">
	                                                ...
	                                                <label class="col-md-3 control-label" style="text-align:right;">질문세부분류 :  </label>
		                                                <div class="col-md-3">
		                                                	<input class="form-control" type="text" placeholder="제목을 입력 하세요." value="<%=bbs.getBbsCategorySub()%>" readOnly="true">
		                                                </div>
	                                            </div>
	                                            <%} %>
                        				...
                        				<div class="col-md-2 text-right" style="padding-right:20px;">
                        					<!-- <button class="btn btn-inverse waves-effect waves-light" type="button" onclick="javascript:goResponse();">답변</button>
                                     		<button class="btn btn-primary waves-effect waves-light" type="button" onclick="javascript:goMod();">수정</button>
	                                        <button class="btn btn-warning waves-effect waves-light" type="button" >취소</button> -->
        ...
        <script type="text/javascript">
			...
			function goMod(){
				...
				if(confirm("수정 하시겠습니까?")){
					...
					<%}else{%>
						document.location.href = "<%=contextPath%>/reply/mod.do?bbsParentId=<%=bbs.getBbsParentBbsId()%>&bbsPostId=<%=bbs.getBbsId()%>&bbsType=BO2";
					<%}%>
					}
    		}
    		...
    		function goReply(){
    			...
    			document.location.href = "<%=contextPath%>/reply/reg.do?bbsPostId=<%=bbsPostId%>&bbsType=BO2";
			...
			function goResponse(){
				...
				document.location.href = "<%=contextPath%>/qna/response.do?bbsPostId=<%=bbsPostId%>";
			}
    			...
    			$.ajax({
    				...
    				success:function(data) {
						...
						if(firstChild){
    						...
    						cmtHtml += '<button class="btn-sm btn-default waves-effect waves-light" id="" style:"" type="button" value="'+data.commentId+'" onclick="javascript:commentMod(this);">수정</button>';
