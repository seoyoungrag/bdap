        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <div class="content" style="margin-top:60px;">
                    <div class="container">
						<h4 class="m-t-0 header-title" style="padding:10px;"><b>개발요청 진행 현황</b></h4>
        ...
        <script type="text/javascript">
			...
			function goMod(){
				...
				if(confirm("수정 하시겠습니까?")){
					...
					<%}else{%>
						document.location.href = "<%=contextPath%>/reply/mod.do?bbsParentId=<%=bbs.getBbsParentBbsId()%>&bbsPostId=<%=bbs.getBbsId()%>&bbsType=BO5";
					<%}%>
					}
    		}
    		...
    		function goReply(){
    			...
    			document.location.href = "<%=contextPath%>/reply/reg.do?bbsPostId=<%=bbsPostId%>&bbsType=BO5";
