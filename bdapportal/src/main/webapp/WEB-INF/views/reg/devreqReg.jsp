        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <div class="content" style="margin-top:60px;">
                    <div class="container">
                    <form class="form-horizontal" role="form" id="devreqRegForm" name="devreqRegForm" method="post" action="<%=contextPath%>/devreq/insert.do" accept-charset="utf-8">
						<h4 class="m-t-0 header-title" style="padding:10px;"><b>개발요청 진행 현황 등록</b></h4>
                        				...
                        				<div class="col-md-6" style="padding-right:20px;">
	                                            ...
	                                            <div class="form-group" style="margin-bottom:10px;">
	                                                ...
	                                                <div class="col-md-3 text-right">
                                     					<button class="btn btn-primary waves-effect waves-light" type="button"  onclick="javascript:devreqInsert();">등록</button>
