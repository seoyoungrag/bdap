        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <div class="content" style="margin-top:60px;">
                    <div class="container">
                    <form class="form-horizontal" role="form" id="linkageRegForm" name="linkageRegForm" method="post" action="<%=contextPath%>/linkage/insert.do" accept-charset="utf-8">
						<h4 class="m-t-0 header-title" style="padding:10px;"><b>비정기자료 연동 진행현황 등록</b></h4>
                        				...
                        				<div class="col-md-6" style="padding-right:20px;">
	                                            ...
	                                            <div class="form-group" style="margin-bottom:10px;">
	                                                ...
	                                                <div class="col-md-3 text-right">
                                     					<button class="btn btn-primary waves-effect waves-light" type="button"  onclick="javascript:linkageInsert();">등록</button>
